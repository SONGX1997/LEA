...
# Instantiate and load checkpoints for a list of model specs
def instantiate_models(specs, args):
    """
    Build DDP models from (config_path, checkpoint_path) specs.
    """
    from detectron2.checkpoint import DetectionCheckpointer
    models = []
...
# Entry point
def main(args):
    # Test config (choose one)
    test_cfg = load_cfg(
        "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_coco.py",
        args.opts,
        args
    )
    # test_cfg = load_cfg(
    #     "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_s1_060.py",
    #     args.opts,
    #     args
    # )
    # test_cfg = load_cfg(
    #     "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_s1_050.py",
    #     args.opts,
    #     args
    # )

    # Model specs: (config_path, checkpoint_path)
    model_specs = [
        (
        ...
        (
            "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_s2_4080.py",
            "../output/coco_s2_4080/model_final.pth"
        ),
    ]
    # Alternative
    # model_specs = [
    ...
    #         "../output/coco_s1_070/model_final.pth"
    #     ),
    #     (
    #         "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_s5_7080.py",
    #         "../output/coco_s2_7080_c16/model_final.pth"
    #     ),
    # ]
    ...
    #     ),
    #     (
    #         "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_s2_4060.py",
    #         "../output/coco_s2_4060_c32/model_final.pth"
    #     ),
    # ]
