...
def main(args):
    ...
    model_specs = [
        ...
        (
            "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_s3_6080.py",
            "../output/coco_s3_6080_c32/model_final.pth"
        ),
    ]
    # Alternative specs for model2 and model3:
    # model_specs = [
    #     (
    #         "../../detectron2/projects/ViTDet/configs/COCO/mask_rcnn_vitdet_b_50ep_s1_040.py",
    #         "../output/coco_s1_040/model_final.pth"
