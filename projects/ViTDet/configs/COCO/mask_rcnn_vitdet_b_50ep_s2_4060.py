...
DATASET_ROOT = '../../../../datasets/coco/subcat4060'
...
DatasetCatalog.register("coco_s2_4060_train", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH, "coco_s2_4060_train"))
MetadataCatalog.get("coco_s2_4060_train").set(json_file=TRAIN_JSON, image_root=TRAIN_PATH, evaluator_type="coco", **get_dataset_instances_meta_train())
...
DatasetCatalog.register("coco_s2_4060_val", lambda: load_coco_json(VAL_JSON, VAL_PATH, "coco_s2_4060_val"))
MetadataCatalog.get("coco_s2_4060_val").set(json_file=VAL_JSON, image_root=VAL_PATH, evaluator_type="coco", **get_dataset_instances_meta_val())

dataloader.train.dataset.names = "coco_s2_4060_train"
...
dataloader.test.dataset.names = "coco_s2_4060_val" 
