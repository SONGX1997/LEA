...
DATASET_ROOT = '../../../../datasets/coco/subcat070'
...
DatasetCatalog.register("coco_s1_train_070", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH, "coco_s1_train_070"))
MetadataCatalog.get("coco_s1_train_070").set(json_file=TRAIN_JSON, image_root=TRAIN_PATH, evaluator_type="coco", **get_dataset_instances_meta_train())
...
DatasetCatalog.register("coco_s1_val_070", lambda: load_coco_json(VAL_JSON, VAL_PATH, "coco_s1_val_070"))
MetadataCatalog.get("coco_s1_val_070").set(json_file=VAL_JSON, image_root=VAL_PATH, evaluator_type="coco", **get_dataset_instances_meta_val())

dataloader.train.dataset.names = "coco_s1_train_070"
...
dataloader.test.dataset.names = "coco_s1_val_070"
dataloader.evaluator = L(COCOEvaluator)(
    dataset_name="${..test.dataset.names}",
    output_dir = "output/coco_s1"
)

model.roi_heads.num_classes = 70

# # Schedule
train.max_iter = 113983*8
train.eval_period = 10000
train.checkpointer = dict(period=20000, max_to_keep=100)

lr_multiplier.scheduler.milestones = [105916*8, 110000*8]
