...
DATASET_ROOT = '../../../../datasets/coco/subcat050'
...
DatasetCatalog.register("coco_s1_train_050", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH, "coco_s1_train_050"))
MetadataCatalog.get("coco_s1_train_050").set(json_file=TRAIN_JSON, image_root=TRAIN_PATH, evaluator_type="coco", **get_dataset_instances_meta_train())
...
DatasetCatalog.register("coco_s1_val_050", lambda: load_coco_json(VAL_JSON, VAL_PATH, "coco_s1_val_050"))
MetadataCatalog.get("coco_s1_val_050").set(json_file=VAL_JSON, image_root=VAL_PATH, evaluator_type="coco", **get_dataset_instances_meta_val())

dataloader.train.dataset.names = "coco_s1_train_050"
...
dataloader.test.dataset.names = "coco_s1_val_050"
...
model.roi_heads.num_classes = 50
