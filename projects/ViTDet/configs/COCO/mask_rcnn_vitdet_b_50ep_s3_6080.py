...
DATASET_ROOT = '../../../../datasets/coco/subcat6080'
...
DatasetCatalog.register("coco_s3_6080_train", lambda: load_coco_json(TRAIN_JSON, TRAIN_PATH, "coco_s3_6080_train"))
MetadataCatalog.get("coco_s3_6080_train").set(json_file=TRAIN_JSON, image_root=TRAIN_PATH, evaluator_type="coco", **get_dataset_instances_meta_train())
...
DatasetCatalog.register("coco_s3_6080_val", lambda: load_coco_json(VAL_JSON, VAL_PATH, "coco_s3_6080_val"))
MetadataCatalog.get("coco_s3_6080_val").set(json_file=VAL_JSON, image_root=VAL_PATH, evaluator_type="coco", **get_dataset_instances_meta_val())

dataloader.train.dataset.names = "coco_s3_6080_train"
...
dataloader.test.dataset.names = "coco_s3_6080_val"
